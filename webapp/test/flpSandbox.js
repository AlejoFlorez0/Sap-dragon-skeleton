		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#saparagodragonskeletondragonskeleton-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"saparagodragonskeletondragonskeleton-display": {
								"semanticObject": "saparagodragonskeletondragonskeleton",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.arago.dragonskeleton.dragonskeleton",
									"url": sap.ui.require.toUrl("sap/arago/dragonskeleton/dragonskeleton")
								}
							}
						}
					}
